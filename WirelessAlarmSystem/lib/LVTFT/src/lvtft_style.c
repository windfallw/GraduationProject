...
static void set_lv_style_top_status_bar(lv_style_t *style, lv_style_t *font)
{
    ...
    lv_style_set_pad_all(style, TOP_STATUS_BAR_PAD_ALL);
    ...
    lv_style_set_pad_hor(font, TOP_STATUS_BAR_FONT_PAD_HOR);
}
...
static void set_lv_style_bottom_status_bar(lv_style_t *style, lv_style_t *font)
{
    ...
    lv_style_set_radius(style, 0);
    lv_style_set_border_width(style, 2);
    lv_style_set_pad_all(style, BOTTOM_STATUS_BAR_PAD_ALL);
    ...
    lv_style_set_pad_hor(font, BOTTOM_STATUS_BAR_FONT_PAD_HOR);
}
